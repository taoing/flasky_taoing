...
from .. import db
from .forms import LoginForm,Registration,ChangePassword,PasswordResetRequestForm,PasswordResetForm,ChangeEmailForm
...
def login():
	...
	if form.validate_on_submit():
		...
		if user is not None and user.verify_password(form.password.data):
			...
			return redirect(request.args.get('nest') or url_for('main.index'))
